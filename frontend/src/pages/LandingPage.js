        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 text-center">
            <p className="text-slate-500 text-sm">
              Lizenzschlüssel erforderlich. <a href="mailto:kontakt@welkora.net" className="text-blue-600 hover:underline">Kontaktieren Sie uns</a> für eine Demo oder individuelle Anfragen.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-slate-900 text-white py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-slate-800 pt-8 text-center text-slate-400">
            <p>© 2025 Welkora. Alle Rechte vorbehalten.</p>
          </div>
        </div>
      </footer>
    </div>
